    ...
    return (
        ...
        <div class="about bg-light" id="about">
            ...
            <div class="para-text">
                ...
                <p>Currently seeking an oppotunity in the tech industry.
                        Frequently praised as quality-oriented by my peers. I can be relied upon to help your company achieve its goals.</p>
            </div>
        </div>
    );
}
